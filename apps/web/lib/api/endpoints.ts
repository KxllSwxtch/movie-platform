...
export const endpoints = {
  ...
  watchHistory: {
    ...
    updateProgress: (contentId: string) =>
  ...
  adminPartners: {
    ...
    rejectCommission: (id: string) =>
      `/admin/partners/commissions/${id}/reject`,
    ...
    approveWithdrawal: (id: string) =>
      `/admin/partners/withdrawals/${id}/approve`,
    rejectWithdrawal: (id: string) =>
      `/admin/partners/withdrawals/${id}/reject`,
    completeWithdrawal: (id: string) =>
      `/admin/partners/withdrawals/${id}/complete`,
  },
  ...
  adminNotifications: {
    ...
    sendNewsletter: (id: string) =>
      `/admin/notifications/newsletters/${id}/send`,
    scheduleNewsletter: (id: string) =>
      `/admin/notifications/newsletters/${id}/schedule`,
    cancelNewsletter: (id: string) =>
      `/admin/notifications/newsletters/${id}/cancel`,
  },
  ...
  adminVideo: {
    ...
    uploadUrl: (contentId: string) =>
      `/admin/content/${contentId}/video/upload-url`,
    status: (contentId: string) => `/admin/content/${contentId}/video/status`,
    delete: (contentId: string) => `/admin/content/${contentId}/video`,
    thumbnails: (contentId: string) =>
      `/admin/content/${contentId}/video/thumbnails`,
  },
