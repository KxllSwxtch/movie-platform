...
export function AppSidebar({ className }: AppSidebarProps) {
  ...
  const collapsedClass = isSidebarCollapsed
  ? 'md:w-[72px]'
  : 'md:w-[260px]';
  ...
  return (
    <>
      ...
      >
        ...
        <div className={cn('shrink-0 pb-[26px]', isSidebarCollapsed ? 'px-2.5' : 'px-[20px]')}>
          <CollapsedNavTooltip label="Загрузить" collapsed={isSidebarCollapsed}>
            ...
            >
              <span className={cn('relative truncate', isSidebarCollapsed && 'md:hidden')}>
                Загрузить
              </span>
            </Link>
          </CollapsedNavTooltip>
        ...
        >
          {navGroups.map((group) => (
            <div key={group.label}>
              <div className={cn('mb-1.5 px-[16px]', isSidebarCollapsed && 'md:hidden')}>
              ...
              <div
                className={cn(
                  'space-y-0.5',
                  !isSidebarCollapsed && "relative mx-0 pb-[12px] after:absolute after:bottom-0 after:left-[54px] after:right-[36px] after:h-px after:bg-white/18 after:content-['']",
                )}
              >
        ...
        <div className={cn('shrink-0 space-y-0.5', isSidebarCollapsed ? 'px-2 py-2' : 'px-0 pb-2 pt-1')}>
          <button
            type="button"
            ...
            className={cn(
              ...
              isSidebarCollapsed ? 'h-[27px] justify-center rounded-lg px-0' : 'h-[27px] gap-3 px-[32px]',
            )}
          >
            {isSidebarCollapsed ? (
