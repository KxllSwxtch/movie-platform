...
export class PartnerDashboardDto {
  ...
  @ApiProperty({ example: 'ABCD1234', description: 'Partner referral code' })
  referralCode!: string;

  @ApiProperty({ example: 'https://movieplatform.ru/register?ref=ABCD1234', description: 'Partner referral URL' })
  referralUrl!: string;
